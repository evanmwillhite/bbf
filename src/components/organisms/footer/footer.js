...
export default () => (
  <footer className={styles.footer}>
    <div className={styles.footerWrap + ' wrapper'}>
      ...
      <p><span className={styles.copyright}>Copyright © {(new Date().getFullYear())} Believers Baptist Fellowship - All Rights Reserved.</span><span className={styles.copyright}><a href="tel:+1-615-517-8800">(615) 517-8800</a></span><span className={styles.copyright}><a href="mailto:akowillhite@gmail.com">akowillhite@gmail.com</a></span></p>
    </div>
  </footer>
)
